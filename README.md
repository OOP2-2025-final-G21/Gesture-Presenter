...
- K24108 中島颯太 https://github.com/nakashima02405|  スライド管理・実行画面作成   | スライド実行画面のUI作成、左右ボタンによるスライド操作（右スワイプ／左スワイプ相当）、スライド終了ボタン、一括削除機能を担当。  
- K24138 水野堪太 https://github.com/kinako1415|  ファイルアップロード機能　   | ファイルアップロード画面の作成、アップロード処理の実装、スライド再生ボタンの作成を担当。  
- K24014 石丸竜也 https://github.com/maru14000000|  画像変換・システム連携   　　|pptxファイルを画像へ変換する処理、フロントエンドとバックエンドの連携、デバッグ用カメラ描画、手のランドマーク取得を担当。
